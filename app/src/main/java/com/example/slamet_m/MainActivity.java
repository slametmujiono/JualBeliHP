...
import com.example.slamet_m.adapter.ListAdapterHandphone;
import com.example.slamet_m.model.Handphone;
import com.example.slamet_m.server.AsyncInvokeURLTask;

//import androidx.support.v4.view.MenuItemCompat;
...
// TODO Auto-generated method stub
            ...
            task.mNoteItWebUrl = "http://localhost/JUALBELIHPANDROIDPROJECT/submit_phone.php";
            task.execute();
        } catch (Exception e) {
            e.printStackTrace();
        }
...
// TODO Auto-generated method stub
            ...
            task.applicationContext = MainActivity.this;
            task.mNoteItWebUrl = "http://localhost/JUALBELIHPANDROIDPROJECT/delete_phone.php";
            task.execute();
        } catch (Exception e) {
            e.printStackTrace();
        }
